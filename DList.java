...
public class DList extends List {
  ...
  public void insertBack(Object item) {
    ...
    public boolean isInList(Comparable c) {
        if (size > 0) {
            DListNode node = (DListNode) this.front();
    ...
    /** 
     * removeBack() removes a node from the back of the DList 
     * If DList is empty won't do anything.
     **/
